...
public class Run4 {
	...
	private VFSGroupDataset<FImage> trainingData; // training dataset
	private VFSGroupDataset<FImage> testingData; // testing dataset
	...
	// Run 3 constructor - initialises/loads both the training and testing data
	Run4() {
		try {
	...
	// Main method to perform the classification process
	public void performClassification() throws IOException, FileNotFoundException {
